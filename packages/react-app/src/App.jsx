...
function App(props) {
  ...
  const rewardInterest = useContractReader(readContracts, "Staker", "rewardInterest");
  console.log("💵 Reward Rate:", rewardInterest);
      ...
      <BrowserRouter>
        ...
        <Switch>
          <Route exact path="/">
            ...
            <div style={{ padding: 8, marginTop: 16 }}>
              <div>Reward interest Per 30 Seconds:</div>
              <p>40%</p>
            </div>
            ...
            <div style={{ padding: 8 }}>
              <Button
                type={"default"}
                onClick={() => {
                  tx(writeContracts.Staker.restore());
                }}
              >
                📡 restore
              </Button>
            ...
            <div>
              <input placeholder="Enter stake amount" onChange={setAmount} />
            </div>
            <div style={{ padding: 8 }}>
              <Button
